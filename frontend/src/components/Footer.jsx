// frontend/src/components/Footer.jsx - With Real Icons
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h3 className="text-xl font-bold text-green-400 mb-4 flex items-center gap-2">
              <svg className="w-6 h-6 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4v16h16V4H4zm2 2h12v12H6V6zm2 2v8h8V8H8zm2 2h4v4h-4v-4z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 10h6v4H9v-4z" />
              </svg>
              Norland Health
            </h3>
            <p className="text-gray-300 text-sm">
              Certified Chinese Wellness products for better health and vitality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm text-gray-300 grid grid-cols-2 gap-x-4">
              <li>🇺🇬 Uganda</li>
              <li>🇰🇪 Kenya</li>
              <li>🇹🇿 Tanzania</li>
              <li>🇷🇼 Rwanda</li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-4 text-center text-sm text-gray-400">
          <p>© {new Date().getFullYear()} Norland Health DRC. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
